...
void serialConsolePoll()
{
	...
	while (Serial.available()) {
		...
		if (c == '\n' || c == '\r') {
			...
			// switch USB mode: 0=steam 1=xbox 2=hori 3=lizard 4=swpro 5=ps5 6=hidgyro 7=ps5-game/clean 8=ds4-game/clean 9=ps3(dualshock3) 10=original xbox 13=switch2-pro/clean
			else if (line[0] == 'x') {
